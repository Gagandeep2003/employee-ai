...
import { PaperPlaneRight, X, ChatCircleDots, User, PaperPlaneTilt, Robot, Sparkle } from "@phosphor-icons/react";
            ...
            <div className="relative">
              ...
              {!reducedMotion && orbAnimation === 'greeting' && (
                <div className="absolute -top-1 -right-1 ai-orb-wave">
                  <Sparkle size={12} weight="fill" className="text-yellow-300" />
                </div>
              )}
            </div>
          )}
